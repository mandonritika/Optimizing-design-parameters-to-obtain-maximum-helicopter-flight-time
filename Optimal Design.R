...
library(readxl)
table= read_excel("Supplementary Docs/616_data2_v2.xlsx")
names(table)
...
table1 = read_excel("Supplementary Docs/dispersion calc.xlsx")
...
library(olsrr)
df= read_excel("Supplementary Docs/test_v2.xlsx")
names(df)
...
library(olsrr)
df1= read_excel("Supplementary Docs/Dispersion calculations.xlsx")
names(df1)
